...
Our NMKE Knowledge Editing Framework is improved based on the implementation of Alphaedit in the EasyEdit repository. To reproduce the relevant code of this project, please follow the two steps below:

Replace the transformers environment in your Conda setup: Specifically, replace the modeling_llama.py file in the path /miniconda3/envs/EasyEdit/lib/python3.9/site-packages/transformers/models/llama/. For detailed guidance on this step, you can refer to the neuron-attribution repository (https://github.com/zepingyu0512/neuron-attribution).

Replace the core implementation file of Alphaedit: You only need to replace the file easyeditor/models/alphaedit/AlphaEdit_main.py in the。Alphaedit directory with the open-sourced NMKE_main.py.
